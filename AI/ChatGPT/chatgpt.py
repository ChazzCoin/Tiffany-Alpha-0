...
from AI.ChatGPT.authentication import OpenAIAuthentication
from AI.ChatGPT.sessions import HTTPSession, HTTPTLSSession
from AI.ChatGPT.utils import get_utc_now_datetime
from AI.ChatGPT.errors import ChatgptError, ChatgptErrorCodes
...
class Conversation:
    ...
    DEFAULT_CONFIG_PATH = f"{cwd}/config.json"
